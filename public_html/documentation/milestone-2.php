...
<br>
<p>Interactive features and functionality</p>
<section class="Welcome-Context">
<div class="Welcome">
	<h2>Welcome:</h2>

		<li>This will be my background context (Sandia Mountain img).</li>
		<li>My personal Logo</li>
		<li>Drop down feature</li>
		<li>Links lead to other area's of my page</li>
	<br>
	...
	<li>The current companies that I am representing/contracted with in NM.</li>
	<li>Detail of experience of past experience and serving my community.</li>
	<li>I would like to give details about who I am, what I enjoy doing with my free time</li>
...
<div class="contact-form-container">
	...
	<li>I'd have an additional content box for additional information they'd
		like to speak about.</li>
	<li>This contact form would go directly to my e-mail.</li>
	<li>My logo in a faded background</li>
